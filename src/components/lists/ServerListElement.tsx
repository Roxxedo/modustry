...
export default function ListElement({ value }: GenericServerPropsData) {
    return (
        <>
            <Link href={"/server/" + serverNameToId(value.name)} className="mods-item list-group-item list-group-item-action d-flex gap-3 my-1 rounded-4 shadow border-0" aria-current="true" key={""}>
