...
export default function GHListElement({ value }: GenericInputPropsGithub) {
    return (
        <>
            <div className="list-group-item list-group-item-action my-1 lh-sm text-white rounded-4 shadow border-0" style={{background: "#26292f"}} aria-current="true">
                ...
                {value.assets.map((value, index, array) => (
                    <>
                        ...
                        <div className="mb-1 text-white"> <span>Download count: {value.download_count}</span> </div>
